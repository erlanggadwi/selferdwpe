...
require('./videfikriself.js')
nocache('./videfikriself.js', module => console.log(`${module} Updated!`))
...
const start = async (erdwpe = new erdwpe()) => {
    ...
    erdwpe.onAnyMessage((async (message) => {
        require('./videfikriself.js')(erdwpe, message)
    }))
